...
#include <Client.h>
#include <IPAddress.h>
#include "HAintegrationDefines.h"
...
public:
    ...
    /**
     * Registers a new callback method that will be called each time a disconnection to the MQTT broker is acquired.
     *
     * @param callback Callback method.
     */
...
private:
    ...
    /// The callback method that will be called when the MQTT disconnection is acquired.
